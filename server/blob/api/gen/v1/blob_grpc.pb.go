...
type BlobServiceClient interface {
	CreateBlob(ctx context.Context, in *CreateBlobReq, opts ...grpc.CallOption) (*CreateBlobRsp, error)
	GetBlob(ctx context.Context, in *GetBlobReq, opts ...grpc.CallOption) (*GetBlobRsp, error)
	GetBlobURL(ctx context.Context, in *GetBlobURLReq, opts ...grpc.CallOption) (*GetBlobURLRsp, error)
}
...
func (c *blobServiceClient) CreateBlob(ctx context.Context, in *CreateBlobReq, opts ...grpc.CallOption) (*CreateBlobRsp, error) {
	out := new(CreateBlobRsp)
...
func (c *blobServiceClient) GetBlob(ctx context.Context, in *GetBlobReq, opts ...grpc.CallOption) (*GetBlobRsp, error) {
	out := new(GetBlobRsp)
...
func (c *blobServiceClient) GetBlobURL(ctx context.Context, in *GetBlobURLReq, opts ...grpc.CallOption) (*GetBlobURLRsp, error) {
	out := new(GetBlobURLRsp)
...
type BlobServiceServer interface {
	CreateBlob(context.Context, *CreateBlobReq) (*CreateBlobRsp, error)
	GetBlob(context.Context, *GetBlobReq) (*GetBlobRsp, error)
	GetBlobURL(context.Context, *GetBlobURLReq) (*GetBlobURLRsp, error)
...
func (UnimplementedBlobServiceServer) CreateBlob(context.Context, *CreateBlobReq) (*CreateBlobRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateBlob not implemented")
}
func (UnimplementedBlobServiceServer) GetBlob(context.Context, *GetBlobReq) (*GetBlobRsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBlob not implemented")
}
func (UnimplementedBlobServiceServer) GetBlobURL(context.Context, *GetBlobURLReq) (*GetBlobURLRsp, error) {
...
func _BlobService_GetBlob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlobServiceServer).GetBlob(ctx, req.(*GetBlobReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BlobService_GetBlobURL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlobServiceServer).GetBlobURL(ctx, req.(*GetBlobURLReq))
	}
	return interceptor(ctx, in, info, handler)
}
