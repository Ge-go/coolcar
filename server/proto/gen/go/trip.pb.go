...
type Trip struct {
	...
	Start       string      `protobuf:"bytes,1,opt,name=start,proto3" json:"start,omitempty"` //第一个字段
	StartPos    *Location   `protobuf:"bytes,5,opt,name=start_pos,json=startPos,proto3" json:"start_pos,omitempty"`
	PathPos     []*Location `protobuf:"bytes,6,rep,name=path_pos,json=pathPos,proto3" json:"path_pos,omitempty"`
	End         string      `protobuf:"bytes,2,opt,name=end,proto3" json:"end,omitempty"`                                     //第二个字段
	DurationSec int32       `protobuf:"varint,3,opt,name=duration_sec,json=durationSec,proto3" json:"duration_sec,omitempty"` //牵扯到单位,带上单位
	FeeCent     int32       `protobuf:"varint,4,opt,name=fee_cent,json=feeCent,proto3" json:"fee_cent,omitempty"`
	Status      TripStatus  `protobuf:"varint,7,opt,name=status,proto3,enum=coolcar.TripStatus" json:"status,omitempty"`
}
...
func (x *GetTripRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTripRsp) ProtoMessage() {}

func (x *GetTripRsp) ProtoReflect() protoreflect.Message {
	mi := &file_trip_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTripRsp.ProtoReflect.Descriptor instead.
func (*GetTripRsp) Descriptor() ([]byte, []int) {
	return file_trip_proto_rawDescGZIP(), []int{3}
}

func (x *GetTripRsp) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *GetTripRsp) GetTrip() *Trip {
	if x != nil {
		return x.Trip
	}
	return nil
...
var file_trip_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x6c, 0x6f, 0x6e, 0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x22, 0xf7, 0x01, 0x0a, 0x04,
	...
	0x74, 0x68, 0x5f, 0x70, 0x6f, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x63,
	...
	0x07, 0x66, 0x65, 0x65, 0x43, 0x65, 0x6e, 0x74, 0x12, 0x2b, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x63, 0x6f, 0x6f, 0x6c, 0x63,
	0x61, 0x72, 0x2e, 0x54, 0x72, 0x69, 0x70, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x1c, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70,
	0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x02, 0x69, 0x64, 0x22, 0x3f, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x52, 0x73,
	...
	0x10, 0x04, 0x32, 0x42, 0x0a, 0x0b, 0x54, 0x72, 0x69, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x33, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x12, 0x13, 0x2e, 0x63,
	0x6f, 0x6f, 0x6c, 0x63, 0x61, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x52, 0x65,
	0x71, 0x1a, 0x13, 0x2e, 0x63, 0x6f, 0x6f, 0x6c, 0x63, 0x61, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x54,
	0x72, 0x69, 0x70, 0x52, 0x73, 0x70, 0x42, 0x1d, 0x5a, 0x1b, 0x63, 0x6f, 0x6f, 0x6c, 0x63, 0x61,
...
var file_trip_proto_goTypes = []interface{}{
	...
	(*GetTripReq)(nil), // 3: coolcar.GetTripReq
	(*GetTripRsp)(nil), // 4: coolcar.GetTripRsp
}
var file_trip_proto_depIdxs = []int32{
	...
	0, // 2: coolcar.Trip.status:type_name -> coolcar.TripStatus
	2, // 3: coolcar.GetTripRsp.trip:type_name -> coolcar.Trip
	3, // 4: coolcar.TripService.GetTrip:input_type -> coolcar.GetTripReq
	4, // 5: coolcar.TripService.GetTrip:output_type -> coolcar.GetTripRsp
