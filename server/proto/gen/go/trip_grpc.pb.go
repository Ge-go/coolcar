...
type TripServiceClient interface {
	GetTrip(ctx context.Context, in *GetTripReq, opts ...grpc.CallOption) (*GetTripRsp, error)
}
...
func (c *tripServiceClient) GetTrip(ctx context.Context, in *GetTripReq, opts ...grpc.CallOption) (*GetTripRsp, error) {
	out := new(GetTripRsp)
...
type TripServiceServer interface {
	GetTrip(context.Context, *GetTripReq) (*GetTripRsp, error)
...
func (UnimplementedTripServiceServer) GetTrip(context.Context, *GetTripReq) (*GetTripRsp, error) {
