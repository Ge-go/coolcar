...
func (s *Service) CreateCar(c context.Context, req *carpb.CreateCarReq) (*carpb.CarEntity, error) {
...
// GetCars gets cars.
func (s *Service) GetCars(c context.Context, req *carpb.GetCarsReq) (*carpb.GetCarsRsp, error) {
	cars, err := s.Mongo.GetCars(c)
	if err != nil {
		s.Logger.Error("cannot get cars", zap.Error(err))
		return nil, status.Error(codes.Internal, "")
	}
	res := &carpb.GetCarsRsp{}
	for _, cr := range cars {
...
func (s *Service) LockCar(c context.Context, req *carpb.LockCarReq) (*carpb.LockCarRsp, error) {
	...
	s.publish(c, car)
	return &carpb.LockCarRsp{}, nil
}

// UnlockCar signals an unlock command to the specified car.
func (s *Service) UnlockCar(c context.Context, req *carpb.UnlockCarReq) (*carpb.UnlockCarRsp, error) {
	...
	s.publish(c, car)
	return &carpb.UnlockCarRsp{}, nil
}

// UpdateCar updates the cars position and status without
// precondition checks.
// Good to be called by car software/firmware.
func (s *Service) UpdateCar(c context.Context, req *carpb.UpdateCarReq) (*carpb.UpdateCarResponse, error) {
